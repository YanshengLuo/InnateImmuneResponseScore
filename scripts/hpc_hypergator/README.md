...
- PROJECT_ROOT : where your project lives under <HiPerGator_project_path>
...
```bash
ACCOUNT="qsong1"
PROJECT_ROOT="<HiPerGator_project_path>      # <-- change PROJECT_NAME to your folder
...
or just copy:
```bash
sbatch --array=0-9%5 01_star_align_array.slurm <HiPerGator_project_path>
```
------------------------------------------------
...
# QC STEPS (MANDATORY) 鈥?COPY / PASTE SECTION
...
# OUTPUT:
```bash
   <HiPerGator_project_path>
   <HiPerGator_project_path>
   <HiPerGator_project_path>

PROJECT_ROOT="<HiPerGator_project_path>
