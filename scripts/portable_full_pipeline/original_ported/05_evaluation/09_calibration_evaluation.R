...
# -------------------------
# PORTING NOTE: Output and split-design roots may be provided by the portable runner.
# -------------------------
...
split_root <- Sys.getenv(
  "IMRS_PORTED_SPLIT_DESIGN_ROOT",
  unset = file.path(project_root, "00_metadata", "verified_metadata", "splited")
)
